  ...
  return (
    <div className="wcl">
      ...
      <section className="wcl-pk-wrap" id="packages">
        ...
        <p className="wcl-plan-note">Already on the Complete Material? Your plan includes corrections too — <b>Foundation Sprint 2</b>, <b>Precision Engine 3</b>, <b>Elite Clearance 7</b>, <b>Total Clearance 10</b>. These packs add on top.</p>
      </section>
